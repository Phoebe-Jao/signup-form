...
const Form = () => {
  ...
  return (
    <form action="" onSubmit={handleFormSubmit} className="bg-custom-white flex flex-col justify-center items-center px-10 max-sm:px-6 py-10 max-sm:py-6 rounded-[0.8rem]">
      ...
      <p className="text-[0.7rem] text-custom-purple-700 tracking-wide pt-3 max-sm:pt-5 max-sm:text-center">By clicking the button, you are agreeing to <br className="max-sm:block" />our <a href="#" className="font-bold">Terms and Conditions</a></p>
    </form>
  )
}
